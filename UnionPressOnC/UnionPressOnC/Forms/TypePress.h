...
#include "Repositories/CTypeRepository.h"
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Load += gcnew System::EventHandler(this, &TypePress::TypePress_Load);
...
#pragma endregion
	...
	private: System::Void TypePress_Load(System::Object^ sender, System::EventArgs^ e) {
		Logger logger;
		logger.Log("Открытие формы", "PeriodForm.cs", "PeriodPress", "92");
	}
	public: void SetTypePressListBindingSource(BindingSource^ ppList)
	{
		gridType->DataSource = ppList;
	}
	...
	private: void btnLoadPeriod_Click(Object sender, EventArgs e)
	{
		...
		ITypeView tView = this;
		string sqlConnectionString = ConfigurationManager.ConnectionStrings["UnionPressDB"].ConnectionString;
		ITypeRepository typeRepository = gcnew CTypeRepository(sqlConnectionString);

		Logger logger;
		logger.Log("Загрузка из бд", "Type.cs", "btnLoadType", "247");
	}
	...
	private: void btnExportType_Click(Object sender, EventArgs e)
	{
		...
		Logger logger;
		logger.Log("Экспорт", "Type.cs", "Type", "261");
	}
	...
	private: void ExpMenuItemExcel_Click(Object sender, EventArgs e)
	{
		...
		Logger logger;
		logger.Log("Экспорт в Excel", "Type.cs", "ExpMenuItemExcel", "272");
	}
	...
	private: void ExpMenuItemWord_Click(Object sender, EventArgs e)
	{
		...
		Logger logger;
		logger.Log("Экспорт в Word", "Type.cs", "ExpMenuItemWord", "281");
	}
};
}
